...
"""VR M3 full-body robot constants.

This module configures the VR M3 humanoid.
"""
...
VR_M3_1_XML: Path = Path(__file__).parent / "xmls" / "vr_m3_1.xml"
assert VR_M3_1_XML.exists(), f"VR M3 XML not found at {VR_M3_1_XML}"
...
def get_spec() -> mujoco.MjSpec:
    spec = mujoco.MjSpec.from_file(str(VR_M3_1_XML))
...
VR_M3_1_IMPLICIT_ACTUATORS = {
    ...
    "waist_yaw": BuiltinPositionActuatorCfg(
        target_names_expr=("waist_yaw_joint",),
        stiffness=VR_M3_1_STIFFNESS["waist_yaw"],
        damping=VR_M3_1_DAMPING["waist_yaw"],
        effort_limit=VR_M3_1_EFFORT_LIMITS["waist_yaw"],
        armature=VR_M3_1_ARMATURE["waist_yaw"],
        frictionloss=VR_M3_1_STATIC_FRICTION["waist_yaw"],
    ),
    "shoulder_pitch": BuiltinPositionActuatorCfg(
        target_names_expr=(".*_shoulder_pitch_joint",),
        stiffness=VR_M3_1_STIFFNESS["shoulder_pitch"],
        damping=VR_M3_1_DAMPING["shoulder_pitch"],
        effort_limit=VR_M3_1_EFFORT_LIMITS["shoulder_pitch"],
        armature=VR_M3_1_ARMATURE["shoulder_pitch"],
        frictionloss=VR_M3_1_STATIC_FRICTION["shoulder_pitch"],
    ),
    "shoulder_roll": BuiltinPositionActuatorCfg(
        target_names_expr=(".*_shoulder_roll_joint",),
        stiffness=VR_M3_1_STIFFNESS["shoulder_roll"],
        damping=VR_M3_1_DAMPING["shoulder_roll"],
        effort_limit=VR_M3_1_EFFORT_LIMITS["shoulder_roll"],
        armature=VR_M3_1_ARMATURE["shoulder_roll"],
        frictionloss=VR_M3_1_STATIC_FRICTION["shoulder_roll"],
    ),
    "shoulder_yaw": BuiltinPositionActuatorCfg(
        target_names_expr=(".*_shoulder_yaw_joint",),
        stiffness=VR_M3_1_STIFFNESS["shoulder_yaw"],
        damping=VR_M3_1_DAMPING["shoulder_yaw"],
        effort_limit=VR_M3_1_EFFORT_LIMITS["shoulder_yaw"],
        armature=VR_M3_1_ARMATURE["shoulder_yaw"],
        frictionloss=VR_M3_1_STATIC_FRICTION["shoulder_yaw"],
    ),
    "elbow_pitch": BuiltinPositionActuatorCfg(
        target_names_expr=(".*_elbow_pitch_joint",),
        stiffness=VR_M3_1_STIFFNESS["elbow_pitch"],
        damping=VR_M3_1_DAMPING["elbow_pitch"],
        effort_limit=VR_M3_1_EFFORT_LIMITS["elbow_pitch"],
        armature=VR_M3_1_ARMATURE["elbow_pitch"],
        frictionloss=VR_M3_1_STATIC_FRICTION["elbow_pitch"],
    ),
    "wrist_yaw": BuiltinPositionActuatorCfg(
        target_names_expr=(".*_wrist_yaw_joint",),
        stiffness=VR_M3_1_STIFFNESS["wrist_yaw"],
        damping=VR_M3_1_DAMPING["wrist_yaw"],
        effort_limit=VR_M3_1_EFFORT_LIMITS["wrist_yaw"],
        armature=VR_M3_1_ARMATURE["wrist_yaw"],
        frictionloss=VR_M3_1_STATIC_FRICTION["wrist_yaw"],
    ),
    "wrist_roll": BuiltinPositionActuatorCfg(
        target_names_expr=(".*_wrist_roll_joint",),
        stiffness=VR_M3_1_STIFFNESS["wrist_roll"],
        damping=VR_M3_1_DAMPING["wrist_roll"],
        effort_limit=VR_M3_1_EFFORT_LIMITS["wrist_roll"],
        armature=VR_M3_1_ARMATURE["wrist_roll"],
        frictionloss=VR_M3_1_STATIC_FRICTION["wrist_roll"],
    ),
    "wrist_pitch": BuiltinPositionActuatorCfg(
        target_names_expr=(".*_wrist_pitch_joint",),
        stiffness=VR_M3_1_STIFFNESS["wrist_pitch"],
        damping=VR_M3_1_DAMPING["wrist_pitch"],
        effort_limit=VR_M3_1_EFFORT_LIMITS["wrist_pitch"],
        armature=VR_M3_1_ARMATURE["wrist_pitch"],
        frictionloss=VR_M3_1_STATIC_FRICTION["wrist_pitch"],
    ),
}
...
HOME_KEYFRAME = EntityCfg.InitialStateCfg(
    ...
    joint_pos={
        ...
        "waist_yaw_joint": 0.0,
        # Shoulders (arms slightly forward, asymmetric roll)
...
VR_M3_1_IMPLICIT_ARTICULATION = EntityArticulationInfoCfg(
    actuators=tuple(VR_M3_1_IMPLICIT_ACTUATORS.values()),
    soft_joint_pos_limit_factor=0.9,
)


def get_vr_m3_1_implicit_actuator_robot_cfg() -> EntityCfg:
    ...
    return EntityCfg(
        ...
        spec_fn=get_spec,
        articulation=VR_M3_1_IMPLICIT_ARTICULATION,
    )


# Action scale: maps normalized actions to joint position offsets.
VR_M3_1_ACTION_SCALE: dict[str, float] = {}
for a in VR_M3_1_IMPLICIT_ARTICULATION.actuators:
    ...
    for n in names:
        VR_M3_1_ACTION_SCALE[n] = 0.25 * e / s

if __name__ == "__main__":
    import mujoco.viewer as viewer
    from mjlab.entity.entity import Entity

    robot = Entity(get_vr_m3_1_implicit_actuator_robot_cfg())
    print(f"Robot has {robot.num_joints} joints")
    print(f"Actuated joints: {robot.num_actuators}")
    print(f"Action scale: {VR_M3_1_ACTION_SCALE}")

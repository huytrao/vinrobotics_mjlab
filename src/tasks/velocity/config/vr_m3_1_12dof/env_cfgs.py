...
"""VinRobotics VR M3 1 12 DOF (lower-body only) velocity environment configurations.
...
from src.assets.robots import VR_M3_1_12DOF_ACTION_SCALE, get_vr_m3_1_12dof_implicit_actuator_robot_cfg
from src.tasks.velocity.terrains.config import TERRAINS_CFG

##
# VR M3 1 12 DOF specific constants
##
...
def vr_m3_1_12dof_rough_env_cfg(play: bool = False) -> VelocityEnvCfg:
    """Create VR M3 1 12 DOF terrain velocity configuration."""
    ##
    # Sensors
    ##
    ...
    actions: dict[str, ActionTermCfg] = {
        "joint_pos": JointPositionActionCfg(
            entity_name="robot",
            actuator_names=(".*",),
            scale=VR_M3_1_12DOF_ACTION_SCALE,
    ...
    scene = SceneCfg(
        terrain=terrain,
        entities={"robot": get_vr_m3_1_12dof_implicit_actuator_robot_cfg()},
...
def vr_m3_1_12dof_flat_env_cfg(play: bool = False) -> VelocityEnvCfg:
    """Create VR M3.1 12 DOF flat terrain velocity configuration."""
    cfg = vr_m3_1_12dof_rough_env_cfg(play=play)
    cfg.sim.njmax = 700
